...
export default function DoseCard({ schedule_id, medication_name, dosage, time_of_day, status, logged_at, onLog, readOnly, now, adherence, adherence_count, dailyProgress, urgency: urgencyProp }) {
